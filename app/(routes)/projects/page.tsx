...
const ProjectsPage: NextPage = () => {
  ...
  const renderIcon = (iconName: string, iconClassName?: string) => {
    ...
    return <div className={iconClassName}>{IconComponent}</div>;
  };
    ...
    <section className='page-container lg:flex-col'>
      ...
      <section className='mt-5 flex flex-col gap-3 text-slate-500'>
        <p>
          ...
          I hold closest to my heart. Many of them are open-source, so if you come across
          something that piques your interest, feel free to explore the codebase and
